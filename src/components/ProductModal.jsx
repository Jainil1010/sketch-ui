    ...
    return (
        <>
            ...
            <motion.div
                ...
                <div className="relative w-full max-w-5xl bg-[#f8f6ee] border-[6px] border-black rounded-[40px] shadow-[12px_12px_0px_#000] overflow-hidden">
                    <motion.button
                        onClick={close}
                        whileHover={{ x: 4, y: 4 }}
                        whileTap={{ scale: 0.95 }}
                    ...
                    <div className="grid lg:grid-cols-2">
                        ...
                        <div className="p-6 sm:p-8 lg:p-10">
                            ...
                            <h2
                                id="modal-title"
                                className="mt-6 text-3xl sm:text-4xl md:text-5xl font-black uppercase text-[#5B5D30] leading-tight">
                                {product.name}
                            </h2>

                            <p className="mt-6 text-base sm:text-lg leading-relaxed text-zinc-700">
                                {product.description}
                            </p>

                            <div className="mt-8 p-4 sm:p-5 bg-[#e9e8dd] border-4 border-black rounded-3xl">
